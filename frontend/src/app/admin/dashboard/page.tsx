                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      >
                        ...
                        <option value="technology">Blog</option>
                        <option value="business">Story</option>
                        <option value="health">Noval</option>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="https://ik.imagekit.io/your_imagekit_id/image.jpg"
                      required
                    />
                  </div>
                  <div>
...
//                               }
//                               title={
//                                 contact.seen ? "Mark as Unread" : "Mark as Read"
//                               }
//                             >
//                               {contact.seen ? (
//                                 <FaEyeSlash size={18} />
